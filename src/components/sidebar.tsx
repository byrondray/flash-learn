...
import { SlideIn, StaggerContainer, StaggerItem, HoverScale, FadeIn } from "@/components/ui/motion";
...
function SidebarContent() {
  ...
  const getNavigationItems = (userId?: string) => [
    ...
    {
      href: userId ? `/quizQuestions/allTests/${userId}` : "/quizQuestions/allTests/placeholder",
    ...
    {
      href: userId ? `/flashCards/viewAll/${userId}` : "/flashCards/viewAll/placeholder",
      label: "Flashcards",
      icon: Brain,
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        animate={{
                          ...
                          color: item.isActive ? "hsl(var(--primary))" : "inherit"
                        }}
                        transition={{ duration: 0.2 }}
                      >                        <motion.div
                          animate={{
